...
var _storage = _interopRequireDefault(require("../app/storage"));
...
test('check progressive counter', () => {
  const testStore = new _storage.default(utility.getAbsolutePath('dist/__tests__/tmp/.test_storage.json'));
